...
//    private static String BENCHMARK_PROJECT_ROOT_PATH = "/Users/guribhangu/some_stuff";
    ...
    private static void buildQuaityModel(QualityModel baseQualityModel, String benchmarkDirectoryPath) throws CloneNotSupportedException, InterruptedException {
...
//        String[] project_directories = {BENCHMARK_PROJECT_ROOT_PATH};
        ...
        for (String projectPath : project_directories) {
            ...
            // build quality model
            SingleProjectEvaluator.buildQuaityModel(baseQualityModel, projectPath);
            // load quality model
