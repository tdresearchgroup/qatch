...
public class SingleProjectEvaluator {
    ...
    private static String BASE_QUALITY_MODEL_PATH = "/Users/research/IdeaProjects/qatch/Rules_Models_Descriptions/Models/qualityModel.xml";
//    private static String BENCHMARK_PROJECT_ROOT_PATH = "/Users/guribhangu/experiement";
    ...
    private static String PROJECT_RESULT_PATH = "/Users/research/IdeaProjects/qatch/Results";
    private static String BENCHMARKING_QUALITY_MODEL_PATH = "/Users/research/IdeaProjects/qatch/Bookmarking_Quality_Model_Results";
    ...
    private static void buildQuaityModel(QualityModel baseQualityModel, String benchmarkDirectoryPath) throws CloneNotSupportedException, InterruptedException, IOException {
        ...
        FileUtils.deleteDirectory(new File("/Users/research/IdeaProjects/qatch/R_Working_Directory"));
        FileUtils.deleteDirectory(new File("/Users/research/IdeaProjects/qatch/Results"));
        ...
        File benchmarkingRepo = new File("/Users/research/IdeaProjects/qatch/Results/Analysis/BenchmarkResults");
        File[] resultFiles = benchmarkingRepo.listFiles();
        for (File resultFile: resultFiles) {
            resultFile.renameTo(new File("/Users/research/IdeaProjects/qatch/Results/"+resultFile.getName()));
        }
        new File("/Users/research/IdeaProjects/qatch/Results/Analysis").deleteOnExit();
    }
